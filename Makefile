...
src/listings/idris/examples: $(shell find src/listings/idris -name '*.idr') src/listings/idris/examples.ipkg
	cd src/listings/idris && idris --build examples.ipkg

programs: src/listings/idris/examples
